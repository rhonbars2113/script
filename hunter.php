...
---------------------------------------------------------------
KUNG GUSTO MO MAKA AVAIL NG WALANG COMMISSION
JUST  CONTACT  ME  US  ON:  t.me/rhonbars2113
";
//  $';
$ow = "[1;33m";
echo "$ow
...
for ($x = 0;$x < $NoofDum;$x++) {
    $Dummy = readline('INPUT YOUR DUMMY UN: ');
    array_push($dummyarray, "$Dummy",);
}
$pass = readline('INPUT YOUR DUMMY PASS: ');
...
DATA;
    ...
    $databals = '{"amount":"' . 0.60 . '","device":{"deviceId":"f606c43d78f50669","deviceImei":"f606c43d78f50669","deviceModel":"RMX3191","deviceName":"RMX3191","deviceOs":"Android O_MR1 ","isEmulator":false,"notificationToken":"eFEXEC5pTAeXLu7JjIlpNX:APA91bF8I2ZGs8wUNDjpw5lSnzrz8fB652HYMxWBdTGtFRSUaBEd0pHZQvWXAd00ESKVUO_VtYieRQxtfEU7f3RUIHEs5zXGZSVqk5PfbzjZTJQcue0vHYRiEobXHk8JUlTa0nmPCdgR","osVersion":"28"},"recipientId":' .  700001282917  . '}';
